...
dev
Used for development builds. Jenkins builds and pushes the image to the public DockerHub dev repository.

master
Used for production builds. Jenkins builds and pushes the image to the private DockerHub production repository.
